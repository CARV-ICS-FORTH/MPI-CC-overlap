...
all:
	...
	$(mpicc) mpi-isend-m-msg-s-barrier-s-timer.c -o mpi-isend-m-msg-s-barrier-s-timer.out -lm
	$(mpicc) mpi-isend-m-msg-m-barrier-m-timer.c -o mpi-isend-m-msg-m-barrier-m-timer.out -lm
